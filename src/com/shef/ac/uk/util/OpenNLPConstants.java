...
public class OpenNLPConstants extends WebAppConstantCorrector {
	...
	public static String[] NAME_TYPES = {"LOCATION", "ORGANIZATION", "PERSON"};
	public static String[] NAME_TYPE_PATH = {NAME_MODELS_PATH + "location.bin.gz", NAME_MODELS_PATH + "organization.bin.gz", NAME_MODELS_PATH + "person.bin.gz"};
